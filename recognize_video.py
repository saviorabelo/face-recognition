...
def tracking(detector, args):
    ...
    tracker = BYTETracker(args=args, frame_rate=25)
    frame_id = 0

    cap = cv2.VideoCapture("videos/webcam.mp4")
    ...
    video = cv2.VideoWriter("videos/video_recognize.mp4", fourcc, fps_, (w, h))
